...
\begin{document}
	...
	\begin{itemize}
		\item \textbf{Nombre/Descripción:} Base de Datos del Sistema de Gestión [Especificar nombre si se conoce, ej. "Sistema de Gestión de Clientes y Créditos"] utilizado por FINDEPRO.
